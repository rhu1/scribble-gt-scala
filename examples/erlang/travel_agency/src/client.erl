%%-------------------------------------------------------------------
%% @doc TravelAgency demo role: `client`.
%%
%% Role implementation module: implements generated behaviour `gen_client`.
%%
...
-include("client.hrl").
-type state_data() :: #state_data{agency_pid :: pid() | undefined, supplier_pid :: pid() | undefined}.
