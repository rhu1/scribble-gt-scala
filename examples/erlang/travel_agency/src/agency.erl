%%-------------------------------------------------------------------
%% @doc TravelAgency demo role: `agency`.
%%
%% Role implementation module: implements generated behaviour `gen_agency`.
...
-include("agency.hrl").
-type state_data() :: #state_data{client_pid :: pid() | undefined, supplier_pid :: pid() | undefined}.
